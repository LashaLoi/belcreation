        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          ...
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p>
              ...
              палаточного городка, где вы сможете расставить свою палатку. Цена
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4">
              Бог каждого человека наделил особым даром. Поэтому на нашем
              лагере, каждый сможет поделиться своим талантом! Это может быть
              рисование, пение, танцы, сценка, гимнастическое представление и
              многое другое. Также, на «Твоё время» будут присутствовать жюри и
              зрители, которые выберут двух победителей, которым и будут вручены
              призы!
            </p>
            <p>
              <span className="text-red-300">*</span>большая просьба до лагеря
              скачать необходимую музыку на флешку, или взять нужный вам
              реквизит для вашего номера
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4 mt-8">
            <img
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4 font-light">
              ...
              вы сможете за особую плату купить мороженое или батончик.
            </p>
            <div className="mb-4 font-medium text-start sm:ml-6 ml-0">
              <div className="mb-4 font-medium">
                ⁃ Для проживания в домиках вам необходимо наволочка для матраса,
                своё одеяло и подушка.
              </div>
